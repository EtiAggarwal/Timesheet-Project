...
namespace TimeSheet.APP_CODE.DAL
{
    ...
    {
        public static String SQL_GET_TIMESHEET_FOR_EMP = "SELECT ID,PROJECT_ID, PROJECT_NAME, TASK_JIRA_ISSUE_PROXY_KEY, HOURS_PER_DAY, COMMENTS FROM TIMESHEET WHERE EMPLOYEE_ID = @EMPLOYEE_ID";
