...
namespace TimeSheet.APP_CODE.DAL
{
    public class SQL_STRINGS
    {
        ...
        public static String SQL_VALIDATE_LOGIN = "SELECT EMPLOYEE_ID, PASS, USER_GUID, IS_ADMIN, FIRST_NAME ,LAST_NAME,EMAIL_ID FROM USER_LOGIN WHERE EMPLOYEE_ID = @EMPLOYEE_ID";
